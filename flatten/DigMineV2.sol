...
// File @openzeppelin/contracts/token/ERC721/utils/ERC721Holder.sol@v4.9.5
...
// File contracts/Digdragon-mine/DigDragonMineV2.sol
...
contract DigDragonMineV2 is ERC721Holder, ReentrancyGuard, Ownable {
    ...
    modifier updateMineFor(address _miner) {
        ...
        if (_miner != address(0)) {
            ...
            rewardsOf[_miner] = calculateReward(_miner);
            // mark the latest staking / unstaking point of user
            lastUserRewardPerHash[_miner] = lastUpdatedRewardBlock;
        }
        _;
    }
    ...
    function calculateReward(address _miner) public view returns (uint) {
    ...
    function rewardPerHashPower() public view returns (uint) {
        ...
        return
            ...
            (rewardPerBlock *
                (_getCurrentBlock() - lastUpdatedRewardBlock) *
                1e18) /
            totalHashPower;
    }
    ...
    struct MineInfo {
        ...
        uint256 currentRewardPerHashPowere;
